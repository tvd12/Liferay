...
import org.tvd.thptty.slogan.model.SloganClp;
...
public class ClpSerializer {
	public static final String SERVLET_CONTEXT_NAME = "tvd-slogan-contest-portlet";
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(SloganClp.class.getName())) {
			...
			try {
				...
				try {
					Class<?> newModelClass = Class.forName("org.tvd.thptty.slogan.model.impl.SloganImpl",
							true, _classLoader);
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"org.tvd.thptty.slogan.model.impl.SloganImpl")) {
			ClassLoader contextClassLoader = Thread.currentThread()
												   .getContextClassLoader();
