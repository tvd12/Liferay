...
/**
 * The interface for the t y class user role local service.
 *
 * <p>
 * Never modify or reference this interface directly. Always use {@link TYClassUserRoleLocalServiceUtil} to access the t y class user role local service. Add custom service methods to {@link org.tvd.thptty.service.impl.TYClassUserRoleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
 * </p>
 *
 * <p>
 ...
 *
 * @author Ta Van Dung
 * @see TYClassUserRoleLocalServiceUtil
...
public interface TYClassUserRoleLocalService {
	/**
