...
/**
 * The utility for the m s message local service. This utility wraps {@link com.ms.internet.message.service.impl.MSMessageLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 * Never modify this class directly. Add custom service methods to {@link com.ms.internet.message.service.impl.MSMessageLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
 * </p>
 *
 * <p>
 ...
 * @generated
 */
public class MSMessageLocalServiceUtil {
	/**
	...
	*/
	public static com.ms.internet.message.model.MSMessage addMSMessage(
		com.ms.internet.message.model.MSMessage msMessage)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addMSMessage(msMessage);
	}
	...
	*/
	public static com.ms.internet.message.model.MSMessage createMSMessage(
		long messageId) {
		return getService().createMSMessage(messageId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteMSMessage(long messageId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteMSMessage(messageId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteMSMessage(
		com.ms.internet.message.model.MSMessage msMessage)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteMSMessage(msMessage);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ms.internet.message.model.MSMessage getMSMessage(
		long messageId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getMSMessage(messageId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ms.internet.message.model.MSMessage> getMSMessages(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getMSMessages(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getMSMessagesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getMSMessagesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ms.internet.message.model.MSMessage updateMSMessage(
		com.ms.internet.message.model.MSMessage msMessage)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateMSMessage(msMessage);
	}
	...
	*/
	public static com.ms.internet.message.model.MSMessage updateMSMessage(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateMSMessage(msMessage, merge);
	}

	public static com.ms.internet.message.model.MSMessage addNewMessage(
		com.ms.internet.message.model.MSMessage newMessage)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addNewMessage(newMessage);
	}
	...
	public static MSMessageLocalService getService() {
		if (_service == null) {
			Object obj = PortletBeanLocatorUtil.locate(ClpSerializer.SERVLET_CONTEXT_NAME,
					MSMessageLocalService.class.getName());
			...
			_service = new MSMessageLocalServiceClp(classLoaderProxy);
	...
	public void setService(MSMessageLocalService service) {
		_service = service;
	}

	private static MSMessageLocalService _service;
}