...
package com.ms.internet.message.service.messaging;
...
import com.ms.internet.message.service.ClpSerializer;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			MSMessageLocalServiceUtil.clearService();

			MSMSenderLocalServiceUtil.clearService();

			MSMReceiverLocalServiceUtil.clearService();
		}
	}
